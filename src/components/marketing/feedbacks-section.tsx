...
function FeedbackCard({
  ...
  return (
    <motion.button
      ...
      aria-label={`عرض ${alt}`}
      className={cn(
        "group relative block w-full break-inside-avoid overflow-hidden rounded-2xl border border-[var(--color-border)] bg-card shadow-[0_4px_18px_-12px_rgba(0,0,0,0.5)] transition-all duration-300 hover:border-primary/40 hover:shadow-[0_18px_40px_-20px_rgba(229,9,20,0.45)]",
      )}
    >
