...
/* ─── Data ─── */
const FAQS = [
  { q: "إزاي بيوصلي كتاب لعبة الاختبارات؟", a: "كتاب لعبة الاختبارات الكتروني فقط بيوصل على إيميلك أو تليجرام أو واتساب. الهدايا كتاب النكش وكتاب فتح المواضيع بيوصلوا مرفقين في نفس الملف." },
...
const PACKAGE_ITEMS = [
  { title: "الكتاب الأساسي: لعبة الاختبارات", desc: "الخريطة النفسية اللي بتفك "شفرة" دماغها وتخليك تنجح في أصعب اختباراتها بثقة وذكاء.", delay: "0s" },
  { title: "بونص #1: كتاب النكش", desc: "اكسر الحواجز في ثواني.. ضحكها، استفزها بذكاء، وخليك دايمًا جوا دماغها بكل هيبة وكاريزما.", delay: "0.2s" },
  { title: "بونص #2: كتاب فتح المواضيع", desc: "150 سؤال جاهز يخلي الكلام بينكوا مايخلصش أبداً ويعمق العلاقة بشكل طبيعي ويخليها مرتاحة معاك.", delay: "0.4s" },
];
...
export default function BundleOffer() {
  ...
  useEffect(() => {
    function mountPayPal() {
      if (window.paypal) {
        window.paypal.HostedButtons({ hostedButtonId: "KZXLAWVMTU4MY" })
          .render("#paypal-container-KZXLAWVMTU4MY");
      }
    }
    const existing = document.querySelector('script[data-paypal-sdk]');
    if (existing) { mountPayPal(); return; }
    const s = document.createElement("script");
    s.src = "https://www.paypal.com/sdk/js?client-id=BAAfzHP3KHRLtrIMQaGopoG8HlWvPsrNIqsbGxHg-SGFELurasC0ECt330vOGg-5Y3VxJ9Q0U7fcUGuYbo&components=hosted-buttons&disable-funding=venmo&currency=USD";
    s.defer = true;
    ...
    <div dir="rtl" style={{ fontFamily: "'IBM Plex Sans Arabic', sans-serif", overflowX: "hidden" }}>
      ...
      <section style={{ background: "#fff", padding: "80px 20px", position: "relative", overflow: "hidden" }}>
        <div className="max-w-4xl mx-auto" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div className="text-center mt-10">
            <a href="#x-checkout" className="cta-hover"><span>ابدأ رحلة التغيير دلوقتي! 🚀</span></a>
            <SubCaption />
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "linear-gradient(180deg,#f9f9f9 0%,#fff 100%)", padding: "80px 20px" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-10">
            <a href="#x-checkout" className="cta-hover"><span>هتستخسر في نفسك ثمن قهوة؟ ☕</span></a>
            <SubCaption />
          </div>
        </div>
      </section>
            ...
            {PACKAGE_ITEMS.map((p, i) => (
              <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "20px", marginBottom: "25px", padding: "25px", background: "linear-gradient(135deg,#f9f9f9,#fff)", borderRadius: "15px", boxShadow: "0 5px 15px rgba(0,0,0,.08)" }}>
                ...
                <p style={{ margin: 0, fontSize: "1.15rem", lineHeight: 1.5, textAlign: "right" }}>
                  <strong style={{ color: "#000" }}>{p.title}</strong><br />
          ...
          <div style={{ position: "relative", marginTop: "50px" }}>
            ...
            <div style={{ position: "relative", background: "linear-gradient(135deg,#fff9e6,#ffe8b3)", padding: "40px", borderRadius: "20px", border: "3px solid #FFD700", boxShadow: "0 15px 40px rgba(255,215,0,.3)" }}>
              <p style={{ fontSize: "1.8rem", fontWeight: 700, margin: "0 0 10px", color: "#000" }}>
                ⚡ سعر الباقة الكاملة:{" "}
                <span style={{ color: "#ff0055", fontSize: "2.5rem" }}>$17</span>
              </p>
        ...
        <div className="max-w-3xl mx-auto px-4 py-14">
          ...
          <div style={{ background: "#FF4C4C", color: "#fff", padding: "12px 20px", borderRadius: "10px", textAlign: "center", marginBottom: "20px", boxShadow: "0 5px 15px rgba(255,76,76,.4)" }}>
            <p style={{ fontSize: "1.05rem", fontWeight: 700, margin: 0, lineHeight: 1.5 }}>
              🚨 سعر الإطلاق الخاص ($17) متاح لأول 100 نسخة فقط.
            </p>
            <p style={{ fontSize: "0.9rem", margin: "5px 0 0", opacity: .95, fontWeight: 500 }}>
              أنت تحصل على دبلومة كاملة في لعبة الاختبارات أقل من سعر 'وجبة غداء'. هذا السعر غير منطقي ومتاح لفترة محدودة فقط.
            </p>
          </div>

          {/* Price */}
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px", flexDirection: "row-reverse", justifyContent: "flex-end" }}>
            <h4 style={{ fontSize: "3rem", fontWeight: 700, color: "#FFD700", margin: 0, textShadow: "2px 2px 4px rgba(0,0,0,.1)" }}>$17</h4>
          </div>
          ...
          <div id="x-checkout" style={{ background: "linear-gradient(135deg,#fff9e6,#fffef8)", borderRadius: "20px", padding: "40px 35px", margin: "20px 0", boxShadow: "0 15px 40px rgba(255,215,0,.2)", border: "3px solid #FFD700" }}>
            ...
            <div style={{ maxWidth: "400px", margin: "0 auto" }}>
              {/* PayPal button — rendered by SDK via useEffect */}
              <div id="paypal-container-KZXLAWVMTU4MY" />

              {/* Alternative payment */}
              <div style={{ maxWidth: "400px", margin: "15px auto 0" }}>
                <a href="https://tally.so/r/ZjEKja" className="cta-green" target="_blank" rel="noreferrer">
                  <span>📱 طرق تحويل أخرى<br />(STC Pay • برق • انجاز • تحويل بنكي • Crypto)</span>
                </a>
              </div>
            </div>
            ...
            <div style={{ marginTop: "25px", paddingTop: "20px", borderTop: "1px solid #e0e0e0", textAlign: "center" }}>
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "10px", flexWrap: "wrap", marginBottom: "12px" }}>
                <img decoding="async" loading="lazy" src="https://www.paypalobjects.com/webstatic/mktg/logo/pp_cc_mark_37x23.jpg" alt="PayPal" style={{ height: "25px" }} />
                <span style={{ color: "#ccc", fontSize: "0.9rem" }}>|</span>
                <span style={{ color: "#666", fontSize: "0.9rem" }}>✓ Visa</span>
                <span style={{ color: "#666", fontSize: "0.9rem" }}>✓ Mastercard</span>
                <span style={{ color: "#666", fontSize: "0.9rem" }}>✓ Amex</span>
              </div>
      ...
      <section id="Customer-Reviews" style={{ background: "#f9f9f9", padding: "80px 20px" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-10">
            <a href="#x-checkout" className="cta-hover"><span>انضم لآلاف الرجال الناجحين 💪</span></a>
            <SubCaption />
          </div>
        </div>
      </section>
