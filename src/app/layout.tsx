...
export const metadata: Metadata = {
  ...
  description:
    "افهم اللعبة الأزلية وغيّر حياتك. كورسات قوية ومباشرة، محتوى حقيقي مبني على تجارب من أرض الواقع.. القواعد الحقيقية للعبة، وأدوات تطبيقية تنقلك لمستوى \"المعلمة\".",
  keywords: [
    "كورسات",
    "تعلم",
    "عربي",
